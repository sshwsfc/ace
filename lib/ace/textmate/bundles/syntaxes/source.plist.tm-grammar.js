   ...
   [ { begin: '(\\{)'
     ...
     , patterns: 
        ...
        , { begin: '\\b(fileTypes)\\s*(=)'
          ...
          , comment: 'fileTypes'
          , end: '(;)'
          , endCaptures: { '1': { name: 'punctuation.terminator.dictionary.tm-grammar' } }
          , patterns: 
             [ { begin: '(\\()'
          ...
          , patterns: 
             [ { begin: '(\\{)'
               ...
               , patterns: 
                  ...
                  , { include: '#string' }
                  , { begin: '(=)'
                    , beginCaptures: { '1': { name: 'punctuation.separator.key-value.tm-grammar' } }
                    , end: '(;)'
                    , endCaptures: { '1': { name: 'punctuation.terminator.dictionary.tm-grammar' } }
   ...
   , 'comment-keyword': 
      ...
      , patterns: 
         ...
         , { applyEndPatternLast: 1
           , begin: '(\')'
           , beginCaptures: { '1': { name: 'punctuation.definition.string.begin.tm-grammar' } }
           , contentName: 'comment.block.string.tm-grammar'
           , end: '(\')(?!\')'
           , endCaptures: { '1': { name: 'punctuation.definition.string.end.tm-grammar' } }
         ...
         , { begin: '\\b(include)\\s*(=)'
           ...
           , patterns: 
              ...
              , { captures: 
                   ...
                   , '2': { name: 'constant.other.reference.repository-item.tm-grammar' }
   ...
   , scope: 
      { patterns: 
         [ { captures: 
           ...
           , match: '(?x)(\')#OpenString(#Optionallymatchthevalid#scopes,andthefollowing#partofthescope,meaning#anythingelseisinvalidcomment(?:\\.(?:line|block))?|constant(?:\\.(?:numeric|character|language|other))?|entity(?:\\.name(?:\\.(?:function|type|tag|section))?|\\.other(?:\\.(?:inherited-class|attribute-name))?)?|invalid(?:\\.(?:illegal|deprecated))?|keyword(?:\\.(?:control|operator|other))?|markup(?:\\.(?:underline|bold|heading|italic|list|quote|raw|other))?|meta|punctuation(?:\\.(?:definition|section|separator|terminator|whitespace))?|source|storage(?:\\.(?:type|modifier))?|string(?:\\.(?:quoted(?:\\.(?:single|double|triple|other))?|(?:unquoted|interpolated|regexp|other)))?|support(?:\\.(?:function|class|type|constant|variable|other))?|text|variable(?:\\.(?:parameter|language|other))?)?((?<!\')[^\\s,()&|\\[\\]:"\'{}<>*?=^;#]*(?<!\\.))?([^\']*)?(\')#CloseString'
