...
, patterns: 
   ...
   , { captures: 
     ...
     , match: '(?x:\\s*#Leadingwhitespace(\\[)(.+?)(\\])(:)#Referencename[\\t]*#Optionalwhitespace(<?)(\\S+?)(>?)#Theurl[\\t]*#Optionalwhitespace(?:((\\().+?(\\)))#Matchtitleinquotes\u2026|((").+?("))#orinparens.)?#Titleisoptional\\s*#Optionalwhitespace$)'
...
, repository: 
   ...
   , 'image-inline': 
      ...
      , match: '(?x:\\!#Imagesstartwith!(\\[)((?<square>[^\\[\\]\\\\]|\\\\.|\\[\\g<square>*+\\])*+)(\\])#Matchthelinktext.([])?#Spacenotallowed(\\()#Openingparenforurl(<?)(\\S+?)(>?)#Theurl[\\t]*#Optionalwhitespace(?:((\\().+?(\\)))#Matchtitleinparens\u2026|((").+?("))#orinquotes.)?#Titleisoptional\\s*#Optionalwhitespace(\\)))'
   ...
   , 'link-inline': 
      ...
      , match: '(?x:(\\[)((?<square>[^\\[\\]\\\\]|\\\\.|\\[\\g<square>*+\\])*+)(\\])#Matchthelinktext.([])?#Spacenotallowed(\\()#Openingparenforurl(<?)(.*?)(>?)#Theurl[\\t]*#Optionalwhitespace(?:((\\().+?(\\)))#Matchtitleinparens\u2026|((").+?("))#orinquotes.)?#Titleisoptional\\s*#Optionalwhitespace(\\)))'
