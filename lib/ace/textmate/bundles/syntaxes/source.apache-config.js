...
, patterns: 
   ...
   , { begin: '(^Include)'
     , beginCaptures: { '1': { name: 'support.constant.include.start.apache-config' } }
     , end: '(\\n)'
          ...
          , patterns: 
             ...
             , { begin: '[]+'
               ...
               , patterns: 
                  ...
                  , { captures: { '1': { name: 'string.regexp.rewrite-operator.apache-config' } }
                    , match: '[]+(\\[[^\\]]+\\])'
                    }
                  ]
               }
