...
, patterns: 
   ...
   , { begin: '(?x)(?:^|(?:(?<!else|new|=)))((?:[A-Za-z_][A-Za-z0-9_]*::)*+~[A-Za-z_][A-Za-z0-9_]*)\\s*(\\()'
     , beginCaptures: 
...
, repository: 
   ...
   , block: 
      ...
      , patterns: 
         [ { captures: 
           ...
           , match: '(?x)((?!while|for|do|if|else|switch|catch|enumerate|return|r?iterate)(?:\\b[A-Za-z_][A-Za-z0-9_]*+\\b|::)*+)\\s*(\\()'
   ...
   , constructor: 
      { patterns: 
         [ { begin: '(?x)(?:^\\s*)((?!while|for|do|if|else|switch|catch|enumerate|r?iterate)[A-Za-z_][A-Za-z0-9_:]*)\\s*(\\()'
           , beginCaptures: 
              { '1': { name: 'entity.name.function.c++' }
              , '2': { name: 'punctuation.definition.parameters.c' }
              }
         ...
         , { begin: '(?x)(:)((?=\\s*[A-Za-z_][A-Za-z0-9_:]*\\s*(\\()))'
