   ...
   , xml_tags: 
      { patterns: 
         ...
         , { begin: '((<)((date))(>))'
           ...
           , end: '((</)((date))(>))'
           , patterns: 
              [ { match: '(?x)[0-9]{4}#Year-#Divider(0[1-9]|1[012])#Month-#Divider(?!00|3[2-9])[0-3][0-9]#DayT#Separator(?!2[5-9])[0-2][0-9]#Hour:#Divider[0-5][0-9]#Minute:#Divider(?!6[1-9])[0-6][0-9]#SecondZ#Zulu'
