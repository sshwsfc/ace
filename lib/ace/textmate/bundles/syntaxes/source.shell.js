...
, repository: 
   { 'case-clause': 
      { patterns: 
         [ { begin: '(?=\\S)'
           ...
           , patterns: 
              [ { begin: '(\\(|(?=\\S))'
                , captures: { '0': { name: 'punctuation.definition.case-pattern.shell' } }
                , end: '\\)'
   ...
   , 'compound-command': 
      { patterns: 
         [ { begin: '(\\[{2})'
           , captures: { '1': { name: 'punctuation.definition.logical-expression.shell' } }
           , end: '(\\]{2})'
         ...
         , { begin: '(\\({2})'
           , beginCaptures: { '0': { name: 'punctuation.definition.string.begin.shell' } }
           , end: '(\\){2})'
         ...
         , { begin: '\\b(case)\\b'
           ...
           , patterns: 
              [ { begin: '\\b(?:in)\\b'
                ...
                , patterns: [ { include: '#case-clause' }, { include: '$self' } ]
                }
              , { include: '$self' }
              ]
           }
