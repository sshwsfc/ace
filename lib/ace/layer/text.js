...
(function() {
    ...
    this.$renderLine = function(stringBuilder, row, tokens) {
		...
		if(tokens.genString){
			//for cacade line output
			tokens.genString(stringBuilder, 
				{'textLayer': this, 'tabString':this.$tabString, 'spaceRe': spaceRe, 'spaceReplace': spaceReplace, 'characterWidth': characterWidth});	
		} else {
